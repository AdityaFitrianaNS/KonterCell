...
// Mengambil id_telkomsel pada url yang dikirimkan dari button ubah yang ada pada data_paket.php
$id_telkomsel = $_GET['id_telkomsel'];
$data = query("SELECT * FROM tb_telkomsel WHERE id_telkomsel = $id_telkomsel")[0];
...
<body>
   ...
   <div class="container-lg">
      <div class="card">
         <!-- Form ubah -->
         <form action="../../controllers/telkomsel/proses_ubah.php" method="post">
            <h4 class="mb-4 mt-4 text-center ">Form Ubah Paket Telkomsel</h4>
            <div class="row ms-5 me-0">
               ...
               <div class="col-md-10">
                  <div class="input-group input-group-merge">
                     ...
                     <!-- input hidden -->
                     <input type="hidden" name="id_telkomsel" value="<?= $data['id_telkomsel'] ;?>">
                     ...
                     <select class="form-select" name="nama_paket" id="nama_paket" required >
                        ...
                        <option value="2.5 GB">2.5 GB</option>
                        <option value="4.5 GB">4.5 GB</option>
