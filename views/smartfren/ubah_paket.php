...
// Mengambil id_smartfren pada url yang dikirimkan dari button ubah yang ada pada data_paket.php
$id_smartfren = $_GET['id_smartfren'];
$data = query("SELECT * FROM tb_smartfren WHERE id_smartfren = $id_smartfren")[0];
...
<body>
   ...
   <div class="container-lg">
      <div class="card">
         <!-- Form ubah -->
         <form action="../../controllers/smartfren/proses_ubah.php" method="post">
            <h4 class="mb-4 mt-4 text-center ">Form Ubah Paket Smartfren</h4>
            <div class="row ms-5 me-0">
               ...
               <div class="col-md-10">
                  <div class="input-group input-group-merge">
                     ...
                     <!-- input hidden -->
                     <input type="hidden" name="id_smartfren" value="<?= $data['id_smartfren'] ;?>">
                     ...
                     <select class="form-select" name="nama_paket" id="nama_paket" required >
                        ...
                        <option disabled>Paket Paket</option>
