...
$jumlah_data = count(query("SELECT * FROM tb_indosat"));
...
$query = query("SELECT * FROM tb_indosat ORDER BY nama_paket ASC LIMIT $awal_data, $jumlah_per_halaman");

// jika tombol cari ditekan
if (isset($_POST["cari"])) {
    // maka jalankan fungsi cari_indosat
    $query = cari_indosat($_POST["keyword"]);
}
...
<body>
    ...
    <div class="container-md">
        <h2 class="judul" style="text-align: center;">Data Paket Indosat</h2>
        <br>
        <!-- Form & button cari -->
            ...
            <table class="table table-info table-striped table-bordered border-primary" style="text-align: center; vertical-align: middle;">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="ubah_paket?id_indosat=<?= $row['id_indosat']; ?>" class="btn btn-sm btn-primary btn-outline-info btn-table">
                                <i class="bi bi-pencil-square text-white"> Ubah</i>
                            </a>
                            <a href="hapus_paket?id_indosat=<?= $row["id_indosat"]; ?>" class="btn btn-sm btn-primary btn-outline-info btn-table" id="btn-hapus">
