...
// Mengambil id_axis pada url yang dikirimkan dari button ubah yang ada pada data_paket.php
$id_axis = $_GET['id_axis'];
$data = query("SELECT * FROM tb_axis WHERE id_axis = $id_axis")[0];
...
<body>
   ...
   <div class="container-lg">
      <div class="card">
         <!-- Form ubah -->
         <form action="../../controllers/axis/proses_ubah.php" method="post">
            <h4 class="mb-4 mt-4 text-center ">Form Ubah Paket Axis</h4>
            <div class="row ms-5 me-0">
               ...
               <div class="col-md-10">
                  <div class="input-group input-group-merge">
                     ...
                     <!-- input hidden -->
                     <input type="hidden" name="id_axis" value="<?= $data['id_axis'] ;?>">
