...
$query = "INSERT INTO tb_telkomsel VALUES('','$nama_paket','$jenis_paket','$masa_aktif','$harga_asli','$harga_jual', now())";
   ...
   <script>
      Swal.fire({
         ...
         if (result.isConfirmed) {
            document.location.href = '../../views/telkomsel/data_paket';
         }
      })
   </script>
<?php
...
?>
   ...
   <script>
      Swal.fire({
         ...
         if (result.isConfirmed) {
            document.location.href = '../../views/telkomsel/tambah_paket';
         }
      })
   </script>
<?php
