...
$query = "INSERT INTO tb_tri VALUES('','$nama_paket','$jenis_paket','$masa_aktif','$harga_asli','$harga_jual', now())";
   ...
   <script>
      Swal.fire({
         ...
         if (result.isConfirmed) {
            document.location.href = '../../views/tri/data_paket';
         }
      })
   </script>
<?php
...
?>
   ...
   <script>
      Swal.fire({
         ...
         if (result.isConfirmed) {
            document.location.href = '../../views/data_tri/tambah_paket';
         }
      })
   </script>
<?php
